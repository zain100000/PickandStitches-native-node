...
const ProductsList = () => {
  ...
  const handleUpdateProductInfo = selectedProduct => {
    navigation.navigate('UpdateProductInfo', {selectedProduct});
  };
    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-1">
        <FlatList
          ...
          renderItem={({item}) => (
            <View className="flex-row justify-around items-center p-3 border-b-2 border-b-gray-400 ">
              ...
              <View className="flex-1 flex-row justify-around items-center gap-8">
                <Text
                  className="flex-1"
                  style={{fontFamily: 'Montserrat-SemiBold'}}>
                  {item.title}
              ...
              <View className="w-16 flex-row item-center justify-between flex-wrap left-4">
                <TouchableOpacity onPress={() => handleUpdateProductInfo(item)}>
        ...
        {/* Conditionally render message when no products */}
